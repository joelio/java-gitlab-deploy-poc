#!/bin/bash
# Improved script to run GitLab CI jobs locally
...
# Source the simplified test functions
echo "Loading functions from tests/simplified-test-functions.sh..."
source tests/simplified-test-functions.sh
...
echo ""
echo "For more advanced testing with the official GitLab Runner:"
echo "1. Install GitLab Runner: brew install gitlab-runner"
echo "2. Create a .gitlab-ci.yml file with your jobs"
echo "3. Run: gitlab-runner exec shell job_name"
